...
| §164.312(a)(2)(iv) | Encryption at rest | AES-256-GCM per `server/utils/encryption.js`. PHI fields enumerated in `CLAIM_PHI_FIELDS` and `USER_PHI_FIELDS`. Key fingerprint logged with each ciphertext for rotation traceability. |
